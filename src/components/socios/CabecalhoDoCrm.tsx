...
export const ROTA_DAS_ASSINATURAS = `${ROTA_DO_CRM}/assinaturas`;
...
export function CabecalhoDoCrm({ resumo }: { resumo: string }) {
   ...
   *
   * Um `NavLink` normal não resolve: `/socios/crm` é prefixo de
   * `/socios/crm/feedbacks` também, então ou ele acende nos dois ou apaga na
   * ficha — e a ficha É a seção de leads, com o modal aberto por cima.
   *
