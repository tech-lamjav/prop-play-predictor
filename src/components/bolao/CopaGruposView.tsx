...
interface CopaGruposViewProps {
  /** Esconde o footer "Verde = classificado..." quando renderizado em contexto mais limpo. */
  hideFooterLegend?: boolean;
}

/**
 * Tabela dos 12 grupos da Copa 2026 calculada a partir dos jogos finalizados.
 *
 * Usado em dois lugares:
 *   - Inline na tab "Tabela" do BolaoEmptyState
 *   - Dentro do CopaGruposModal (wrapper Dialog)
 *
 * Antes vivia inline dentro do CopaGruposModal. Foi extraído pra evitar
 * duplicação da lógica de cálculo de standings.
 */
export const CopaGruposView: React.FC<CopaGruposViewProps> = ({ hideFooterLegend = false }) => {
