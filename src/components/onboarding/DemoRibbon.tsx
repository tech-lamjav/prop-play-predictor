...
// Marcação de "dados de exemplo" mostrada enquanto o tour guiado preenche a
// tela com conteúdo fictício. Usa ambers default do Tailwind (não tokens de
// tema) pra funcionar igual em theme-bolao e theme-rebrand.
