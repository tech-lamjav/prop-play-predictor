-- ============================================================
-- BOLÃO: expor custom_banner_url em get_user_boloes
-- ============================================================
-- Os cards de "Meus bolões" agora mostram o logo do bolão (se houver)
-- no lugar do troféu genérico. Precisamos do custom_banner_url no RPC.
-- ============================================================
