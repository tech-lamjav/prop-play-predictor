...
-- oportunidade.
--
-- ⚠️ VISÍVEL EM ALGUM MOMENTO DA VIDA DELA, e não no instante em que nasceu.
-- Esta foi a primeira versão desta migration, e estava errada — o code review
-- pegou. Uma versão do snapshot vale de `dbt_valid_from` até `dbt_valid_to`, e
-- a do Brentford +0,5 nasceu em 15/09 com o mercado ainda escondido e ficou
-- viva até 16/09 06h04: entre a volta do mercado, às 02h07, e as 06h04 ela
-- estava visível e acima do limiar, e é ali que o assinante a viu e o daily a
-- enviou. Julgando pelo nascimento, ela era descartada, todas as versões
-- seguintes estavam abaixo do limiar já vigente, a coluna saía nula e a linha
-- continuava escondida — isto é, a correção não corrigia nada.
--
-- A versão foi visível se existe algum instante da vida dela em que:
--
--   · o mercado estava na vitrine — fora de qualquer período escondido da
--     `futebol_mercados_ocultos`; E
--   · o limiar de valor ainda não vigia, OU a vantagem daquela versão passava
--     nele.
--
