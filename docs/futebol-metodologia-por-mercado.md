...
| **O número embaixo da premissa** (a evidência) | **Quatro rotas, nesta ordem**: critério transcrito no frontend; valor medido pelo mart, RPC 158; histórico jogo a jogo, RPC 117; perfil de temporada, RPC 094 | Release / migration |
